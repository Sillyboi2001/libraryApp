...
var rentBook = function rentBook(sequelize, DataTypes) {
  var rentedbooks = /*#__PURE__*/function (_Sequelize$Model) {
    _inherits(rentedbooks, _Sequelize$Model);

    var _super = _createSuper(rentedbooks);

    function rentedbooks() {
      _classCallCheck(this, rentedbooks);

      return _super.apply(this, arguments);
    }

    _createClass(rentedbooks, null, [{
      key: "associate",
      value:
      /**
...
var rentBooks = rentBook(_user.sequelize, _sequelize["default"].DataTypes);
